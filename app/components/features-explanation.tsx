  ...
  return (
    <section className="max-w-4xl mx-auto py-32 px-6 text-center border-y border-white/5 mt-24">
      <h2 className="font-headline text-4xl mb-8 font-bold tracking-tight">
        A Technocratic Approach to Stability
      </h2>
      <p className="font-sans text-lg text-on-surface-variant leading-relaxed mb-12">
        Nirvana is an innovative platform designed to solve the inherent
        conflicts between founders and builders by replacing traditional,
        high-risk vesting models with an automated ecosystem that ensures
        sustainable alignment. Utilizing code-enforced rules and specific
        models like{" "}
        <span className="text-mint font-bold">Ascend</span>,{" "}
        <span className="text-mint font-bold">Balance</span>, and{" "}
        <span className="text-mint font-bold">Flow</span> to eliminate the
        &apos;vesting gamble&apos; through automated trust.
      </p>
